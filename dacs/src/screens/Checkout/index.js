...
const Checkout = ({ route, navigation }) => {
   ...
   useEffect(() => {
      (async () => {
         ...
         const total = await AsyncStorage.getItem('money')
         setMoney(Number(total))
            ...
            <View style={{
               ...
               <View style={{
                  ...
                  <View style={{
                     ...
                     <Text style={{ marginLeft: 10, fontSize: 18, color: "#676767ff" }}>My Wallet</Text>
                  </View>
            ...
            <Center w="100%">
               ...
               <View style={{
                  ...
                  <View style={{
                     ...
                     <Text style={{ fontSize: 18, color: "#676767ff" }}>{newdiscount} VND</Text>
                  </View>
               </View>
            </Center>
         </ScrollView>
